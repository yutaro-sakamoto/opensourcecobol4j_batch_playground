/* Generated by opensource COBOL 4J 1.0.14 */
...
public class CobolTasklet2 implements CobolRunnable, Tasklet {
  ...
  public void init()
  {
    try {
      ...
      f_g_rec	= CobolFieldFactory.makeCobolField(5, b_g_rec, a_2);	/* g-rec */
      ...
      c_1_file1	= CobolFieldFactory.makeCobolField(9, str_0_file1, a_1);
      c_2_file2	= CobolFieldFactory.makeCobolField(9, str_1_file2, a_1);
      c_3_1	= CobolFieldFactory.makeCobolField(1, "1", a_3);
  ...
  private CobolDataStorage b_f_rec;
  private CobolDataStorage b_g_rec;
  ...
  private AbstractCobolField c_2_file2;
  private AbstractCobolField c_1_file1;
  ...
  /* String literals */
  public static final byte[] str_1_file2 = CobolUtil.stringToBytes("file2.txt");
  public static final byte[] str_0_file1 = CobolUtil.stringToBytes("file1.txt");
  /* File f */
