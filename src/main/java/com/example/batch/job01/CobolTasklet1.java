...
public class CobolTasklet1 implements CobolRunnable, Tasklet {
  ...
  public CobolControl[] contList = {
    ...
    new CobolControl(3, CobolControl.LabelType.label) {
      public Optional<CobolControl> run() throws CobolRuntimeException, CobolGoBackException, CobolStopRunException {
        ...
        {
          b_rec_num.setBytes (str_0_00100, 5);
        }
        ...
        {
          b_rec_num.setBytes (str_1_00200, 5);
        }
  ...
  public void init()
  {
    try {
      ...
      /* PROGRAM-ID : CobolTasklet1 */
      f_rec_num	= CobolFieldFactory.makeCobolField(5, b_rec_num, a_2);	/* rec-num */
      ...
      c_1_file1	= CobolFieldFactory.makeCobolField(9, str_2_file1, a_1);
  ...
  private CobolDataStorage b_rec_num;
  ...
  /* String literals */
  public static final byte[] str_2_file1 = CobolUtil.stringToBytes("file1.txt");
  public static final byte[] str_1_00200 = CobolUtil.stringToBytes("00200");
  public static final byte[] str_0_00100 = CobolUtil.stringToBytes("00100");
  /* File f */
